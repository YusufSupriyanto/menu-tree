  ...
  return (
    ...
    >
      ...
      <div>
        ...
        onChange={handleChange}
        className={`w-full ${formMode === "edit" ? "bg-gray-100" : "bg-gray-50"} border border-gray-200 text-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500`}
